...
export default function ConfigAdmin({ darkMode, setDarkMode }) {
      ...
      <div className="flex items-center gap-4">
        {foto ? (
          ...
          <div
            className={
              darkMode
                ? "w-16 h-16 rounded-full bg-gray-700 flex items-center justify-center cursor-pointer"
                : "w-16 h-16 rounded-full bg-gray-300 flex items-center justify-center cursor-pointer"
            }
            onClick={() => setMostrarModal(true)}
          >
            👤
        ...
        <button
          ...
          className={
            darkMode
              ...
              : "bg-green-900 text-white px-4 py-2 rounded hover:bg-green-700"
          }
        >
          Editar Perfil
        </button>
              ...
              <div className="flex items-center gap-4">
                {foto ? (
                  ...
                  <div
                    className={
                      darkMode
                        ? "w-16 h-16 rounded-full bg-gray-700 flex items-center justify-center"
                        : "w-16 h-16 rounded-full bg-gray-300 flex items-center justify-center"
                    }
                  >
                    👤
                  </div>
